  ...
  globalStore.inMemoryIncidents = [
    {
      ...
      equipment: null,
      tag: 'TT82',
      equipamentoNome: 'Trator de Esteira TT82 (Teleoperado)',
      area: 'Infraestrutura',
      tipoFalha: 'Comunicação',
      falha: 'FALHA NO TELOPER',
      sintoma: 'Sem sinal de teleoperação / Comunicação intermitente',
      dataHoraParada: pastOneHour,
      dataHoraAcionamento: pastOneHour,
      previsaoLiberacao: '16:00',
      ...
      historico: [
        {
          id: 'hist-tt82-1',
          incidentId: 'inc-active-tt82',
          tipoEvento: 'ABERTURA',
          descricao: 'Ocorrência iniciada por John Tavares. Falha: FALHA NO TELOPER',
    ...
    },
    {
      ...
      equipment: null,
      tag: 'CA306',
      equipamentoNome: 'Caminhão Fora de Estrada CAT 797 CA306',
      area: 'Frota Mina',
      tipoFalha: 'Comunicação',
      falha: 'PERDA DE SINAL CCO',
      sintoma: 'Oscilação no rádio de despacho',
      dataHoraParada: pastOneHour,
      dataHoraAcionamento: pastOneHour,
      previsaoLiberacao: '17:00',
      dataHoraLiberacao: null,
      prioridade: 'ALTA',
      status: 'EM_ANDAMENTO',
      responsavel: 'John Tavares',
      ...
      historico: [
        {
          id: 'hist-ca306-1',
          incidentId: 'inc-active-ca306',
          tipoEvento: 'ABERTURA',
          descricao: 'Ocorrência iniciada por John Tavares. Falha: PERDA DE SINAL CCO',
          usuario: 'John Tavares',
          dataHora: pastOneHour,
        },
      ],
    },
    {
      ...
      equipment: null,
      tag: 'PZ35',
      equipamentoNome: 'Perfuratriz Autônoma Atlas Copco PZ35',
      area: 'Frota Mina',
      tipoFalha: 'PLC',
      falha: 'FALHA DE INTERTRAVAMENTO',
      sintoma: 'Alerta no supervisório de navegação',
      dataHoraParada: pastTwoHours,
      dataHoraAcionamento: pastTwoHours,
      previsaoLiberacao: '18:00',
      dataHoraLiberacao: null,
      prioridade: 'MEDIA',
      status: 'EM_ANDAMENTO',
      responsavel: 'John Tavares',
      ...
      historico: [
        {
          id: 'hist-pz35-1',
          incidentId: 'inc-active-pz35',
          tipoEvento: 'ABERTURA',
          descricao: 'Ocorrência iniciada por John Tavares. Falha: FALHA DE INTERTRAVAMENTO',
          usuario: 'John Tavares',
    ...
    },
    {
      ...
      equipment: null,
      tag: 'CA506',
      equipamentoNome: 'Equipamento CA506',
      area: 'Frota Mina',
      tipoFalha: 'Comunicação',
      falha: 'PTX TRAVADO',
